...
function(add_enclave_library target)
    ...
    set(ENCLAVE_LINK_FLAGS "${ENCLAVE_LINK_FLAGS} -Wl,--start-group -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tkey_exchange -lsgx_trts -lsgx_tservice -l${SGX_TSVC_LIB} -l${SGX_DCAP_TVL} -Wl,--end-group")
